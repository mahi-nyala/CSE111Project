        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <ul class="navbar-nav">
              ...
              if (isset($_SESSION['id'])) {
                if ($_SESSION['id'] == 1) {
                  echo "<li class='nav-item'> <a href='suggestions.php' class='nav-link'>Add drama</a> </li>";
                }
              }
              echo"<li class='nav-item'> <a href='homepage.php' class='nav-link'>Back to Home</a> </li>
                  <li class='nav-item'> <a href='account.php' class='nav-link'>Account</a> </li>
                  <li class='nav-item'> <a href='rating.php' class='nav-link'>Rate a Kdrama</a> </li>
                  <li class='nav-item'> <a href='suggestions.php' class='nav-link'>Suggest a Kdrama</a> </li>
                  ...
                  $quer2 = "SELECT * FROM dramas WHERE mid in (SELECT mid from user1 where id = '$id') ";
                  ...
                  <div class='col'>
                    <form action='search.php' method='POST'>
                      <select  name='option' style='padding:5px;'>
                        ...
                        <option value='2'>Release year</option>
                        <option value='3'>Director</option>
                        <option value='4'>Episodes</option>
                      </select>
